...
public class InstellingenPane extends GridPane {
    ...
    private CheckBox gokStrategy1, gokStrategy2, gokStrategy3;
    ...
    public InstellingenPane(InstellingenPaneController instellingenPaneController) {
        ...
        this.textButton = new RadioButton("tex");
        ...
        p22.getChildren().addAll(gokStrategy1, gokStrategy2, gokStrategy3);
